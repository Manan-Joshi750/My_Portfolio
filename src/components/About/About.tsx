    ...
    <>
      <Container id="about">
        <div className="about-text">
          ...
          <div className="education" data-aos="fade-left" data-aos-delay="300">
            <h3>Education:</h3>
          ...
          <div className="experience" data-aos="fade-left" data-aos-delay="400">
            <h3>Experience:</h3>
          ...
          <div className="hard-skills">
            {[python, cIcon, jsIcon, reactIcon, typescriptIcon, viteIcon, cppIcon, mongoIcon, nodeIcon, htmlIcon, cssIcon, boostrapIcon, tailwindIcon, bootstrap5Icon].map((icon, i) => (
              <div className="hability" key={i} data-aos="fade-up" data-aos-delay={100 + i * 50}>
        ...
        <div className="about-image" data-aos="fade-right" data-aos-delay="600">
